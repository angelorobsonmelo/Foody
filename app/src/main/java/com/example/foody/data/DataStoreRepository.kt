...
class DataStoreRepository @Inject constructor(@ApplicationContext private val context: Context) {
    ...
    private object PreferenceKeys {
        ...
        val selectedMainMealTypeId = preferencesKey<Int>(PREFERENCES_MEAL_TYPE_ID)
    ...
    suspend fun saveMealAndDietType(
        ...
        dataStore.edit { preferences ->
            ...
            preferences[PreferenceKeys.selectedMainMealTypeId] = mealTypeId
...
//            preferences[PreferenceKeys.selectedDietTypeId] = dietTypeId
    ...
    val readMealAndDietType: Flow<MealAndDietType> = dataStore.data
        .catch { exception ->
            ...
            val selectedMealTypeId = preferences[PreferenceKeys.selectedMainMealTypeId] ?: 0
